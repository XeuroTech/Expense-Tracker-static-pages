...
export default function AboutPage() {
  return (
    <>
      <Seo
        title="About Us"
        description="Learn about Expense-Tracker's mission and values, built by XeuroTech to make personal finance simpler for everyone."
        path="/about"
      />
      <PageHeader
        eyebrow="About Us"
            ...
            <Grid size={{ xs: 12 }}>
              <Reveal>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.8, mb: 2, maxWidth: 720 }}>
                  Expense-Tracker is built by XeuroTech to solve a simple problem: most expense
