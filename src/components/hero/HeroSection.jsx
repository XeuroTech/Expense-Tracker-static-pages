  ...
  return (
    <Box
      ...
      sx={{
        ...
        overflow: "hidden",
        backgroundImage:
          "linear-gradient(160deg, #0A0A0A 0%, #170D0D 55%, #241414 100%)",
        display: "flex",
        alignItems: "center",
    ...
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(78,205,196,0.35) 0%, rgba(78,205,196,0) 70%)",
          bottom: -160,
          left: -120,
        }}
      />
            ...
            <Reveal>
              ...
              >
                <AutoAwesomeRoundedIcon
                  sx={{ fontSize: "1rem", color: "#FF8A8A" }}
                />
                <Typography
                  variant="body2"
                  sx={{ color: "#FF8A8A", fontWeight: 600, fontSize: "0.8rem" }}
                >
                  AI-Powered
                </Typography>
              </Stack>
              ...
              >
                Track expenses, plan budgets, and visualize your financial life
                with a beautifully simple app built to help you save more and
                stress less.
              </Typography>
              ...
              >
                ...
                <Box
                  sx={{
                    ...
                    borderRadius: "50%",
                    background:
                      "radial-gradient(circle, rgba(255,107,107,0.25) 0%, rgba(255,107,107,0) 70%)",
                    filter: "blur(10px)",
                  }}
                />
                <Box
